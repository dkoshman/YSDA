...
class ConstrainedProbabilityMatrixFactorization(torch.nn.Module):
    def __init__(
        ...
        self.implicit_feedback_norm = torch.tensor(implicit_feedback.sum(axis=1)) + 1e-8
    ...
    def forward(self, user_ids, item_ids):
        ...
        user_factors = (
            user_weight
            + implicit_feedback @ item_rating_effect_weight / implicit_feedback_norm
        )
        ...
        weight_decay(item_rating_effect_weight, self.regularization_lambda)
